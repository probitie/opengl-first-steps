...
//    glDeleteShader(fragmentShader);
    ...
    unsigned char *data = stbi_load("/home/user/projects/code/cpp/GLFW-CMake-starter/wall.jpg", &width, &height, &nChannels, 0);

    if(data)
    {
        // generate texture on the currently bi=ount texturue image
